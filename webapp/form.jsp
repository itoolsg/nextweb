	...
	<div class="container">
		...
		<form action="/board/write" method="post"
			...
			<div class="bottom-action">
				<div class="picture">
					<img id="getpicture" class="getpicture" alt="get picture" onclick="document.getElementById('file').click();"/>
					<c:if test="${board.filename != null}">
						<img src="/images/${board.filename}" alt="image" width="40"
							height="40" />
					</c:if>
					<input id="file" type="file" name="file" onchange="document.getElementById('filename').innerHTML=this.value;"/>
					<div id="filename"></div>
				</div>
