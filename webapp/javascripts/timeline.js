...
//		var width = document.body.offsetWidth;
	...
	addEvent(blackscreen, "click", function() {blackscreen.style.display="none";img_screen.style.display="none";document.body.style.oveflow="auto";});
	addEvent(img_screen, "mousedown", function(e) {prePos = getPosition(e); is_dragging = true;});
